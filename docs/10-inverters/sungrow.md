...
- [Add an isolated MCP2515 CAN channel](../40-setup/40-can-related/can_add_on_mcp2515.md)
- [Add an isolated MCP2518 CAN-FD channel in classic CAN mode](../40-setup/40-can-related/can_fd_add_on_mcp2518fd.md)
- Use [Stark CMR hardware](../30-hardware/stark_cmr.md)
- Use a [CAN filter](../40-setup/40-can-related/can_filter_hardware.md) between inverter and the rest of the system
