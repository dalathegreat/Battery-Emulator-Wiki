...
## Note on CAN-FD
The Gen5 BMW battery architecture uses CAN-FD, so if you plan on integrating this battery, you will need to get the LilyGo T-2CAN, plus a [CAN-FD chip add-on](../40-setup/40-can-related/can_fd_add_on_mcp2518fd.md).

Alternatively, if you want to make it even easier, get the [Stark CMR](../30-hardware/stark_cmr.md) hardware which has built in support for CAN-FD. This is the recommended path!
...
<p align="center" markdown="1">
  ![Hirschmann 805-587-545](../images/bmw-ix-i4-i7-gen5-platform-05.png)<br>
...
<p align="center" markdown="1">
  ![known DTCs](../images/bmw-ix-i4-i7-gen5-platform-07.png)<br>
