---
title: "Dacia Spring / Renault K-ZE ( CMFA-EV platform )"
---
...
This battery also benefits from automated 30s daily resets, which can be automated with BMS power output. See the [Periodic Reset page](../40-setup/10-hardware/periodic_bms_reset.md) for details.
