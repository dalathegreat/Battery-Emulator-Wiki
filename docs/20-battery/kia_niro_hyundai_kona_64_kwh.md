...
This battery has the part number 37501-AO050, and this battery requires a CAN-FD hardware interface. Easiest to get a [Stark CMR](../30-hardware/stark_cmr.md), but you can also add a [CANFD addon interface](../40-setup/40-can-related/can_fd_add_on_mcp2518fd.md). To use this battery, enable the `Kia 64kWh FD battery` option in the software.
