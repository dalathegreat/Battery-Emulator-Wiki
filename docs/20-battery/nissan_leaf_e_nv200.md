...
See the [Periodic Reset page](../40-setup/10-hardware/periodic_bms_reset.md) for details.
...
It's recommended to [set up MQTT](../40-setup/20-software/mqtt.md#home-assistant-discovery) and a [home automation system](../40-setup/20-software/home_assistant.md#chart-examples) which lets you track cell voltages and delta on longer term, to be able to investigate the behaviour. 
