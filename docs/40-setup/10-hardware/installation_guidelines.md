...
!!! tip "TIP"
    You can also add an [equipment stop button](../20-software/equipment_stop.md) to the Battery-Emulator, to make it easier to stop the system
