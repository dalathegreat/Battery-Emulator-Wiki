...
- `BMSRESET` — Triggers a hardware power-cycle of the BMS. **Only acted upon if remote BMS reset is enabled** (see [Remote trigger through MQTT](../10-hardware/periodic_bms_reset.md#remote-trigger-through-mqtt)); otherwise the message is ignored.
