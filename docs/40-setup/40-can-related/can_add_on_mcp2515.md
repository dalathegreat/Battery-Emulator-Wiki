...
!!! tip "TIP"
    If you're considering using a Lilygo T-CAN485, you may find the [Lilygo T-2CAN](../../30-hardware/lilygo_t_2can.md) to be a better choice:
...
- Another option is to use [Stark CMR board](../../30-hardware/stark_cmr.md)
