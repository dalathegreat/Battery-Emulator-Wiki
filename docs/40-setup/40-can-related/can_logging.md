...
## CAN logging basics
The board can operate as a CAN logger, skipping the need for purchasing an expensive tool. There are three ways to log CAN messages, via USB (more reliable), via [Webserver](../20-software/webserver_guide.md) (easiest), and via SD-CARD (requires LilyGo)
...
Start by accessing the [Webserver](../20-software/webserver_guide.md)
