...
CAN networks are vulnerable to lightning strikes. [See the dedicated wiki page for this for more info](../10-hardware/lightning_strike.md) :cloud_with_lightning: 
...
Here is the best way to ensure that there are no paths for spikes in CAN voltage to fry chips on the boards (Important for [Solax](../../10-inverters/solax.md) and [Foxess](../../10-inverters/foxess_h1_h3_ac1_kh.md), other inverters are more lenient on what power supply you use)
