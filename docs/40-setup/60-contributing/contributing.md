...
- [OTA update](../20-software/ota_update.md) the board with this file
...
After downloading the .zip file, extract the .bin file from it. Then [OTA Update](../20-software/ota_update.md) your device with this .bin file!
