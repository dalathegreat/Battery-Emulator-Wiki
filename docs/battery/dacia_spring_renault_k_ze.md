...
This battery also benefits from automated 30s daily resets, which can be automated with BMS power output. See the [Periodic Reset page](../setup/hardware/periodic_bms_reset.md) for details.
