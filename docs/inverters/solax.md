...
An even better way to tackle this is with the use of a CAN isolator between the inverter and the rest of the system. Examples found in the [lightning strike wiki](../setup/hardware/lightning_strike.md#suggested-hardware)
...
* You can use the [Stark CMR](../hardware/stark_cmr.md) hardware
