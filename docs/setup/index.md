...
This section has been expanded [and moved here](can_related/can_wiring_practices_and_troubleshooting.md) 

Note! CAN networks are vulnerable to lightning strikes. [See the dedicated wiki page for this for more info](hardware/lightning_strike.md) :cloud_with_lightning: 
...
* [Chevrolet Volt Gen1](chargers/chevrolet_volt_gen1.md)
* [Nissan LEAF 2013-2024 PDM](chargers/nissan_leaf_pdm.md)

## Shunts
* [BMW S-BOX](hardware/shunt_bmw_sbox.md)
...
!!! tip "TIP"
    Be sure to checkout the [installation guidelines](hardware/installation_guidelines.md) section for how to install your battery
